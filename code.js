...
Code.init = function() {
  ...
  var downloadButton = document.getElementById('downloadButton');
    Code.bindClick(downloadButton,
                   function() {
                       var text = document.getElementById("content_xml").value;
                       download(text, "parsly-workspace.xml");
                   });
  // if ('BlocklyStorage' in window) {
...
Code.initLanguage = function() {
  ...
  document.getElementById('downloadButton').title = "Save Blockly XML";
